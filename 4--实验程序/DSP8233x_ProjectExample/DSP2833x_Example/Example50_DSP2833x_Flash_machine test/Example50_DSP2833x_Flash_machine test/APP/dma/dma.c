...
void SRAM_Test(void)
{
	...
	LCD1602_DispString(1,"                ");
	LCD1602_DispString(2,"                ");
...
//	DELAY_US(500000);
	...
	for (i=0; i<DMA_BUF_SIZE; i++)
	{
		if(DMABuf1[i]!=i)
		{
			LCD1602_DispString(1," ExSRAM Error!  ");
			return;
		}
	}
	LCD1602_DispString(1,"ExSRAM Success! ");

	while(1)
	{

		if(KEYValue!=KEY8_PRESS)
		{
			StopDMACH1();
			return;
		}
